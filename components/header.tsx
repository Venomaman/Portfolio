    ...
    <header className="z-[999] relative">
      <motion.div
       ...
       w-full rounded-none border border-white border-opacity-40
        ...
        dark:bg-gray-950 dark:border dark:border-black/40 dark:bg-opacity-70"
        ...
        <ul className="flex w-[22rem] flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-medium text-gray-500 sm:w-[initial] sm:flex-nowrap sm:gap-5">
          {links.map((link) => (
            ...
            >
              <Link
                className={clsx(
                  "flex justify-center items-center w-full px-3 py-3 hover:text-gray-950 transition dark:text-gray-500 dark:hover:text-gray-300",
                  {
